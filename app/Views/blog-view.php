        ...
        <div class="container aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
            <div class="row">
                <div class="col col-md-10 col-lg-8">
                    <p><i class="bi bi-caret-right"></i> <a href="<?= base_url($locale . '/blog') ?>"><?= lang('Theme.pages.blog') ?></a> <i class="bi bi-caret-right"></i> <?= $post['title'] ?> <i class="bi bi-caret-right"></i></p>
