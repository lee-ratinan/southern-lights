...
$routes->get('services/tag/(:any)', 'Home::services/$1');
$routes->get('services/view', 'Home::serviceView');
$routes->get('promotions', 'Home::promotions');
$routes->get('promotions/tag/(:any)', 'Home::promotions/$1');
...
$routes->get('{locale}/services/tag/(:any)', 'Home::services/$1');
$routes->get('{locale}/services/view', 'Home::serviceView');
$routes->get('{locale}/promotions', 'Home::promotions');
$routes->get('{locale}/promotions/tag/(:any)', 'Home::promotions/$1');
